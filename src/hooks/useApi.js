...
// All API calls are routed through /api/ so CloudFront can apply a single
// cache behaviour (CachingDisabled + CORS headers forwarded) to /api/*
// without affecting S3-backed SPA paths.
const API = `${BASE}/api`
