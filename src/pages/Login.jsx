...
export default function Login() {
  ...
  return (
    <div style={box}>
      <div style={card}>
        <h1 style={{ fontSize: 21, fontWeight: 700, marginBottom: 5 }}>
          {mfa ? 'Two-factor auth' : 'Staff Sign In'}
        </h1>
        <p style={{ fontSize: 13, color: 'var(--muted)', marginBottom: 22 }}>
          {mfa ? 'Enter the 6-digit code from your authenticator app' : 'Tenant portal access'}
        </p>
